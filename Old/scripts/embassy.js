...
const migration = mod3.migrations.fromMapping({
    "0.9.7.2": {
        up: mod3.migrations.updateConfig((config)=>{
            return {
                implementation: config?.wallet.type || "LndRestWallet"
            };
        }, true, {
            version: "0.9.7.2",
            type: "up"
        }),
        down: mod3.migrations.updateConfig((config)=>{
            return {
                wallet: {
                    type: config.implementation || "LndRestWallet"
                }
            };
        }, true, {
            version: "0.9.7.2",
